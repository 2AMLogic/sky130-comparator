...
Ported (issue #8) from 2AMLogic/sky130-sar-adc's sim/harness/testbench.py
(commit b80c144efbf467a586f728726cabb25c1eb5a1f2) -- unchanged logic.
That module is itself a subset of gf180-sar-adc's sim/harness testbench
schema, ported/adapted there -- see sim/README.md "Provenance".
...
def build_netlist(
    ...
    lines: list[str] = []
    a = lines.append
    a(f"* {manifest.name} -- generated by sim/harness (issue #8)")
