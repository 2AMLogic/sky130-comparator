...
#
# Provenance: ported (issue #8) from 2AMLogic/sky130-sar-adc's sim/env.sh
# (commit b80c144efbf467a586f728726cabb25c1eb5a1f2), which itself ports
# from 2AMLogic/gf180-sar-adc's sim/env.sh (commit
# f613571aee5b80eff1eea37bdce9dfc88c5cf396) per that repo's own "Harness
# bootstrap" instruction -- gf180mcu-specific exports (GF180_*) already
# dropped there since sky130's harness has no equivalent per-variant
# metal-stack selection; unchanged here.
