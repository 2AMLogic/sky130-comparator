...
Ported (issue #8) from 2AMLogic/sky130-sar-adc's sim/tests/test_harness.py
(commit b80c144efbf467a586f728726cabb25c1eb5a1f2) -- unchanged, byte-for-
byte logic; every test here exercises the harness modules themselves
(pdk/corners/toolchain/evidence/testbench/runner/mc_runner), none of
which carry any ADC-specific behavior (verified while porting -- see
sim/README.md "Provenance"). Docstring references to "issue #NNN" below
are the ORIGINAL sky130-sar-adc issue numbers each test/regression was
written against, kept as historical citations, not this repo's own issue
numbering."""
